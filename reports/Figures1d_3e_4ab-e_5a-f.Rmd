...
outputFolder = "Figures1d_3e_4ab-e_5a-f_output/"
...
source("../src/functionsForMacaqueAnalysis.r")
source("../src/plotMacaqueCortex.r")
...
laminarMarkers      = read.csv("../analysis/laminar_genes/laminar.summary.all_L1-WM_dev.csv", header=TRUE)
laminarMarkers      = laminarMarkers[laminarMarkers$region=="NCX_Ocx_V1",]
orderedLaminarGenes = read.table("../analysis/laminar_genes/V1(L1-WM)_max_laminar_genes_byage.txt", header=TRUE)
...
pdf(paste(outputFolder,"LaminarSimilarityBetweenAges_top10perc_dots_Fig4b.pdf",sep=""),width=6.5,height=7);
...
write.csv(regOutZZ, paste(outputFolder,"SupplementalTable_V1vsACG_markerGenes.csv",sep=""),row.names=FALSE)
...
```{r clean-up}
# KLUDGE - delete spurious extra file
