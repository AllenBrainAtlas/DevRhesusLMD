...
# Figure 2c, Extended Data Figure 5
...
plot.goids <- c("GO:0045773", "GO:0010977", "GO:0097480", 
                "GO:0050773", "GO:0035933", "GO:0014046", 
                "GO:0006914")
...
# Birth age
abline(v = 5.5, lty = "dashed", col = "grey50")
...
points(rep(10, nrow(avg.onset.age3)), 1:nrow(avg.onset.age3), col = pal.timing[region.timing], pch=15, cex=1)
